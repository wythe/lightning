...
/* Generated stub for json_partial_escape */
struct json_escaped *json_partial_escape(const tal_t *ctx UNNEEDED,
					 const char *str TAKES UNNEEDED)
{ fprintf(stderr, "json_partial_escape called!\n"); abort(); }
